...
class TestAlgo(unittest.TestCase):
    def test_dumb_engine_one_gameday(self):
        ...
        simulator.simulate()
        self.assertEquals(simulator.get_team('A').rating, 90)
        self.assertEquals(simulator.get_team('B').rating, 110)
    ...
    def test_dumb_engine_two_gamedays(self):
        ...
        simulator = GameSimulator(season, engine)
        simulator.simulate()
        self.assertEquals(simulator.get_team('A').rating, 1000)
        self.assertEquals(simulator.get_team('B').rating, 1000)
    ...
    def test_dumb_engine_min_rating(self):
        ...
        simulator = GameSimulator(season, engine)
        simulator.simulate()
        self.assertEquals(simulator.get_team('A').rating, 10)
        self.assertEquals(simulator.get_team('B').rating, 140)
    ...
    def test_dumb_engine_anticipate(self):
        ...
        simulator = GameSimulator(season, engine)
        simulator.simulate()
        self.assertEquals(simulator.get_team('A').rating, 40)
        self.assertEquals(simulator.get_team('B').rating, 160)
